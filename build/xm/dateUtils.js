...
function toNiceUTC(date) {
    return date.getUTCFullYear() + '-' + stringUtils.padLeftZero(date.getUTCMonth() + 1) + '-' + stringUtils.padLeftZero(date.getUTCDate()) + ' ' + stringUtils.padLeftZero(date.getUTCHours()) + ':' + stringUtils.padLeftZero(date.getUTCMinutes());
}
